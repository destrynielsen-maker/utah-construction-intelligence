...
def _source_specific_classification(p: Permit) -> tuple[str, bool, str] | None:
    ...
    if source in {"lehi", "saratoga springs", "eagle mountain", "spanish fork", "springville", "pleasant grove", "vineyard", "payson", "mapleton", "salem", "santaquin", "highland", "alpine", "cedar hills", "lindon", "draper", "sandy", "south jordan", "herriman", "riverton", "west jordan", "salt lake city", "layton", "farmington", "kaysville", "centerville", "bountiful"}:
